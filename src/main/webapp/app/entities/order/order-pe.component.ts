...
@Component({
    selector: 'jhi-order-pe',
    templateUrl: './order-pe.component.html'
})
export class OrderPeComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/order-pe'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: OrderPe) {
        return item.id;
    }
