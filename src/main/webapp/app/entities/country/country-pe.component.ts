...
@Component({
    selector: 'jhi-country-pe',
    templateUrl: './country-pe.component.html'
})
export class CountryPeComponent implements OnInit, OnDestroy {
countries: CountryPe[];
    currentAccount: any;
    ...
    trackId(index: number, item: CountryPe) {
        return item.id;
    }
