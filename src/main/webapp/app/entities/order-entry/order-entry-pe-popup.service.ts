...
@Injectable()
export class OrderEntryPePopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.orderEntryModalRef(component, new OrderEntryPe());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    orderEntryModalRef(component: Component, orderEntry: OrderEntryPe): NgbModalRef {
