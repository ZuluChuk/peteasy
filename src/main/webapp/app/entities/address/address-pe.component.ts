...
@Component({
    selector: 'jhi-address-pe',
    templateUrl: './address-pe.component.html'
})
export class AddressPeComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: AddressPe) {
        return item.id;
    }
