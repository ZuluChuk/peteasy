...
@Injectable()
export class AddressPePopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.addressModalRef(component, new AddressPe());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    addressModalRef(component: Component, address: AddressPe): NgbModalRef {
