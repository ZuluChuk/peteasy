...
@Injectable()
export class ProductPePopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.productModalRef(component, new ProductPe());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    productModalRef(component: Component, product: ProductPe): NgbModalRef {
