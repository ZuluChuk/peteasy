...
public class CartResource {
    ...
    @GetMapping("/carts")
    @Timed
    public ResponseEntity<List<CartDTO>> getAllCarts(@ApiParam Pageable pageable) {
    ...
    @Timed
    public ResponseEntity<List<CartDTO>> searchCarts(@RequestParam String query, @ApiParam Pageable pageable) {
        log.debug("REST request to search for a page of Carts for query {}", query);
        Page<CartDTO> page = cartService.search(query, pageable);
